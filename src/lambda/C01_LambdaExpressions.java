...
public class C01_LambdaExpressions {
    /*
    ...
    private static void printElFunctional(List<Integer> sayiList) {
        sayiList.//actiona'a girecek akis kaynagi call edildi
                stream()//call edilen collection elemanlari akisa alindi
                //.forEach((ebikGabik)-> System.out.println(ebikGabik+" "));
    ...
    private static void printElFunctional1(List<Integer> sayiList) {
        sayiList.//actiona'a girecek akis kaynagi call edildi
                stream()//call edilen collection elemanlari akisa alindi
                .forEach(System.out::print);//akisdaki coll. her bir elemani meth. refere edilerek print edildi
    ...
    private static void printElFunctional2(List<Integer> sayiList) {
        sayiList.//actiona'a girecek akis kaynagi call edildi
                stream()//call edilen collection elemanlari akisa alindi
                .forEach(SeedMethods::intPrint);//akisdaki coll. her bir elemani meth. refere edilerek print edildi

        //meth. refere->meth kaynagi(Class)::method
    }
}
